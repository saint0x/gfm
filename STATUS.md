...
41. Finish Finder-native Trash restore integration beyond the implemented GFM metadata-backed restore operation and successful permanent-delete metadata retirement, including direct platform Trash item identity, Put Back parity, collision sheets, native destructive delete sheets, Empty Trash plumbing, and captured Finder baselines.
