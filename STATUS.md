...
27. Complete Spotlight metadata ingestion beyond the direct batched MDItem-backed reader by adding index-health detection, stale-result quarantine, per-volume throttling, and persisted secondary metadata publication without depending on Spotlight for primary correctness.
