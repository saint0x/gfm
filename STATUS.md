...
40. Implement conflict UI/state machine for apply to all and per-item decisions beyond the implemented operation-engine replace, keep-both, merge-folder, and skip policies with journaled actual destinations or skipped terminal outcomes.
