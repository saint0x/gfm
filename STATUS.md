...
48. Bind the implemented per-volume worker admission limits into extraction and repair job producers beyond the already-wired foreground operation, Quick Look preview, thumbnail generation, and background content indexing producers.
