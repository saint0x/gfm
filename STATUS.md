...
34. Complete end-to-end image-only PDF OCR verification, including retry/backoff accounting under PDF page failures and corruption/missing-input quarantine reporting for rendered-page OCR.
