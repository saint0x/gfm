...
38. Finish large-index merge policy by wiring hot buffer flush triggers, tiered compaction scheduling, physical stale-archive cleanup, and tombstone cleanup cadence across active manifests.
