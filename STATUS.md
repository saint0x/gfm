...
38. Finish Finder-compatible copy preservation for remaining package/edge behavior beyond the implemented symlink preservation, ownership preservation where the host permits it, permissions, access/modified/birth timestamps, copyable xattrs, macOS ACLs, and Finder-package atomic merge-collision guard.
