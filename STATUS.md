...
27. Finish Finder-visible metadata direct macOS binding for FinderInfo alias resolution, bundle display-name rules, sidebar/tag UI propagation, and captured Finder pixel baselines.
