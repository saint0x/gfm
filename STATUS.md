...
38. Finish Finder-compatible copy preservation for remaining edge behavior beyond the implemented symlink object/timestamp preservation, ownership preservation where the host permits it, permissions, access/modified/birth timestamps, post-order recursive directory metadata application, copyable xattrs, macOS ACLs, Finder-package atomic merge-collision guard, and incomplete fresh directory/package copy rollback on cancellation or failure.
