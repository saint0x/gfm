...
47. Bind thermal, battery, IO pressure, and user-activity adaptive scheduling into remaining foreground, preview, thumbnail, and diagnostics-rebuild producers beyond the implemented jobs-layer policy, background content indexing hook, content maintenance hook, sidecar repair hook, and persistent-index repair hook.
