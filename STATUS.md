...
41. Finish Finder-native Trash restore integration beyond the implemented GFM metadata-backed restore operation, successful permanent-delete metadata retirement, and journaled Empty Trash child deletion with per-entry metadata retirement, including direct platform Trash item identity, Put Back parity, collision sheets, native destructive delete sheets, native Empty Trash confirmation/policy binding, and captured Finder baselines.
