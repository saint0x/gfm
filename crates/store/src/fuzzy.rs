...
pub fn write_fuzzy_postings(path: impl AsRef<Path>, postings: &[FuzzyPosting]) -> Result<()> {
    write_fuzzy_postings_checked(path, postings, || Ok(()))
}

pub fn write_fuzzy_postings_checked(
    path: impl AsRef<Path>,
    postings: &[FuzzyPosting],
