...
fn print_usage() {
  ...
  gfm ui-sidebar-volume-topology-invalidation <previous-paths...> -- <current-paths...>
  gfm ui-sidebar-volume-topology-api-reason-invalidation
  ...
  gfm search-index-sidecars-session-provider-invalidation <index.gfmidx> <columns.gfmcols> <metadata.gfmmeta> <prefixes.gfmprefix> <substrings.gfmsubstr> <fuzzy.gfmfuzzy> <content.gfmcontent> <query> <provider-path> <previous-state> <current-state> <reindex-metadata> <state-changed> <provider-reason>
  ...
  gfm search-content-index-set-session-provider-invalidation <records.gfmidx> <query> <provider-path> <previous-state> <current-state> <reindex-metadata> <state-changed> <provider-reason> <content.gfmcontent...>
  ...
  gfm macrobench-capacity <workspace> [smoke|standard|million]
  ...
  gfm parity-capture-plan <plan.tsv> <fixture-root> <artifact-root> <macos-build> <hardware-profile> <display-profile> <app-version> <captured-at> <reviewer> <signer> <approved-mask-set> <light|dark> <1x|2x|3x> <srgb|display-p3> <active|inactive> <x> <y> <width> <height> <GFM.app> [--expires-at <timestamp>]
  gfm parity-capture-matrix <review-root> <plan.tsv> <fixture-root> <artifact-root> <macos-build> <hardware-profile> <display-profile> <app-version> <captured-at> <reviewer> <signer> <approved-mask-set> <light|dark> <1x|2x|3x> <srgb|display-p3> <active|inactive> <x> <y> <width> <height> <GFM.app> [--expires-at <timestamp>]
  gfm parity-capture-manifest <manifest.tsv> <surface> <finder.png> <gfm.png> <mask.tsv|-> <fixture-root> <scenario> <icon|list|column|gallery> <macos-build> <hardware-profile> <display-profile> <app-version> <captured-at> <reviewer> <signer> <approved-mask-set> <light|dark> <1x|2x|3x> <srgb|display-p3> <active|inactive> <width> <height> [--expires-at <timestamp>]
