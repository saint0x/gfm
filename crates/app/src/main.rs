...
fn print_usage() {
  ...
  gfm parity-capture <finder|gfm> <fixture-root> <output.png> <provenance.tsv> <scenario> <icon|list|column|gallery> <macos-build> <hardware-profile> <display-profile> <app-version> <captured-at> <reviewer> <signer> <approved-mask-set> <light|dark> <1x|2x|3x> <srgb|display-p3> <active|inactive> <x> <y> <width> <height> [GFM.app]
  gfm parity-capture-plan <plan.tsv> <fixture-root> <artifact-root> <macos-build> <hardware-profile> <display-profile> <app-version> <captured-at> <reviewer> <signer> <approved-mask-set> <light|dark> <1x|2x|3x> <srgb|display-p3> <active|inactive> <x> <y> <width> <height> <GFM.app>
  gfm parity-capture-manifest <manifest.tsv> <surface> <finder.png> <gfm.png> <mask.tsv|-> <fixture-root> <scenario> <icon|list|column|gallery> <macos-build> <hardware-profile> <display-profile> <app-version> <captured-at> <reviewer> <signer> <approved-mask-set> <light|dark> <1x|2x|3x> <srgb|display-p3> <active|inactive> <width> <height>
