...
fn print_usage() {
  ...
  gfm parity-capture <finder|gfm> <fixture-root> <output.png> <provenance.tsv> <scenario> <icon|list|column|gallery> <macos-build> <hardware-profile> <display-profile> <app-version> <captured-at> <reviewer> <signer> <approved-mask-set> <light|dark> <1x|2x|3x> <srgb|display-p3> <x> <y> <width> <height> [GFM.app]
