...
- `crates/telemetry`: bounded latency histograms, frame timing, UI-thread stall detection, IO/CPU/memory/allocation/queue/compaction summaries, counters, traces, and local diagnostics.
