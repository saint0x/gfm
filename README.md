...
- archive-backed prefix, substring, and fuzzy lookup with explicit candidate budgets, query-level substring gram and fuzzy key/term caps, direct/fuzzy prefix-candidate dedupe, sorted batch prefix, substring, and fuzzy directory scans for uncached query imports, adaptive prefix cutoffs, lookup cache telemetry, truncation telemetry, and mmap-resident sidecars instead of hydrated session heaps
