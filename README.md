...
- sidecar-backed `SidecarIndexQuerySession` objects that keep record, column, metadata, prefix, substring, fuzzy, and content mmap archives open across repeated UI query changes while reusing lookup caches
