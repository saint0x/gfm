...
- one-pass volume bucketing for sidecar posting imports so machine-wide sharded indexes route metadata, prefix, substring, and content candidates to the owning volume without rescanning every posting for every mounted shard
