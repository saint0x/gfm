...
- budgeted content archive-set loading that decodes bounded compressed ID and positional prefixes per term instead of hydrating broad postings before query-time ranking
