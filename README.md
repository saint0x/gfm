...
- bounded ZIP/TAR/TAR.GZ/TAR.BZ2/TAR.XZ/RAR4/RAR5/7Z/GZIP/BZIP2/XZ archive metadata import, archive-scoped versioning, corrupt-input quarantine, encrypted ZIP/RAR quarantine, RAR5 and 7zAES encoded-header quarantine, and safe `unsupported-archive` skips for valid encoded archive surfaces that need deeper decoders
