...
- Query-time prefix, substring, and fuzzy archive lookup:
  ...
  - default sidecar-backed search imports only budgeted query-matching metadata, substring, and content postings before ranking; explicit operator budget commands can lower or raise those caps for diagnostics;
