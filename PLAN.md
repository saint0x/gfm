...
4. Content index
   ...
   - RAR, 7Z, standalone GZIP, standalone BZIP2, and standalone XZ are classified as archive inputs, fingerprinted with the archive extractor version, and skipped as `unsupported-archive` under archive byte budgets until safe metadata readers are implemented.
