...
- Integrates configured runtime payload and progress stores into the shared operation and volume-scoped producer paths so foreground operations, visible preview/repair/index jobs, and thumbnail producers publish durable payload/progress records from the same scheduler choke point.
