...
4. Content index
   ...
   - Background content indexing reports OCR candidates for image-only PDFs and Mac-style screenshot images while keeping primary content extraction bounded and non-blocking; actual OCR execution remains a deferred worker path rather than a foreground indexing dependency.
