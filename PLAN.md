...
- Admits Quick Look preview and thumbnail generation jobs through the same volume-isolated worker path before producing preview contracts, with structured cancellation checks before security classification, scheduling, cache-policy decisions, and native preview/thumbnail planning.
