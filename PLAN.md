...
4. Content index
   ...
   - HTML, RTF, MIME multipart email, and ZIP archive metadata take format-specific extraction paths so markup, transport headers, MIME body parts, control words, and archive entry names become searchable without indexing binary payloads.
