...
4. Content index
   ...
   - Legacy DOC/XLS/PPT files are classified as Office content, fingerprinted with the Office extractor version, parsed through a bounded CFBF directory reader, quarantined when malformed or encrypted, and skipped with an explicit `legacy-office` reason for valid binary packages until full binary text import lands.
